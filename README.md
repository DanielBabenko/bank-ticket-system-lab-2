...
## Проверка системы на соответствие требованиям лабораторной работы №2

Декомпозировать на микросервисы разработанную систему из лабораторной работы 1.

- ❌ Микросервисы должны регистрироваться в Eureka.
- ❌ Микросервисы должны подтягивать конфигурацию из Config-Server.
- ❌ Микросервисы должны быть доступны через Spring Gateway.
